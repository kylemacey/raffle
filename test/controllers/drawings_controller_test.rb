...
class DrawingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drawing" do
    assert_difference("Drawing.count") do
      post drawings_url, params: { drawing: { event_id: @drawing.event_id, slug: @drawing.slug } }
    end
  ...
  test "should update drawing" do
    patch drawing_url(@drawing), params: { drawing: { event_id: @drawing.event_id, slug: @drawing.slug } }
