class SeedApiTokenPermissions < ActiveRecord::Migration[7.0]
  ...
  PERMISSIONS = [
    ["api_tokens.manage", "Manage API tokens", "admin", "Create and revoke no-op API tokens."]
  ].freeze

  ROLE_PERMISSIONS = {
    "platform_admin" => ["api_tokens.manage"],
    "config_admin" => ["api_tokens.manage"]
  }.freeze
